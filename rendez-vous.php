...
if(isset($_POST['dateHour'])) {
  ...
  $sqlQuery = 'INSERT INTO appointments(dateHour) VALUES (:dateHour) LEFT JOIN patients ON appointments.idPatients = patients.id';
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="rendez-vous.php">Rendez-vous!</a>
        </li>
    </div>
  </div>
</nav>
<div class="container text-center w-25 mt-2">
  ...
  <h2 class="text-light">Please provide Your information below in order to get an appointment</h2>
<form action="rendez-vous.php" method="POST" class="mt-2">
<div class="mb-3">
  ...
  <div class="mb-3">
    <label for="mail" class="form-label text-white">E-mail</label>
    <input type="email" name="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="datehour" class="form-label text-white">Date & Hour</label>
